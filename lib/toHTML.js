(function() {
    ...
    // this module is about converting a fountain document into HTML

    var jouvence = require('jouvence').jouvence;
    var Promise = require('es6-promise').Promise;
    var WritableString = require('jouvence').WritableString;


    // if defined, linenoForScene is used to limit the generation
    // to the scene containing the corresponding line number 
    function toHTML(input, output, configuration, linenoForScene, withNavigation) {
